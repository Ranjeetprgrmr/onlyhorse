       ...
       <div className='flex-1 flex overflow-hidden bg-[#00b0f0a6] relative justify-center items-center z-10 bg-noise'>
         ...
         pointer-events-none select-none'
          ...
          <div className='flex flex-col gap-2 px-4 xl:ml-40 text-center md:text-start font-semibold'>
              ...
              width={769}
              height={182}
              className='mt-20 w-[80%] z-0 pointer-events-none select-none'
              />

              <p className='text-2xl md:text-3xl text-balance text-black'>
                  Hey! It's <span className='bg-stone-800 px-2 font-bold text-white'>Not</span> what it looks like.
              </p>
              <p className='text-xl md:text-3xl mb-32 leading-snug text-balance text-black'>
                  Built for <span className='bg-sky-500 font-bold px-2 text-white'>Horses</span> NOT<span className='bg-red-500 px-2 font-bold text-white'>OTHERS</span>
              </p>
              <AuthButtons />
          </div>
       </div>
